...
let SalonlistComponent = class SalonlistComponent {
    constructor(adminServ, toastrServ, geocoder) {
        this.adminServ = adminServ;
        this.toastrServ = toastrServ;
    ...
    showSalonDetails(data) {
        ...
        this.adminServ.getSalonDetails(dataToPass).subscribe((data) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            //  console.log("DSS", data);
            if (data["code"] === 200) {
                this.showSalonDetail = true;
                this.isLoader = false;
                ...
                this.salonEmail = data["data"]["email"];
                this.salonDetails.location = yield this.loadCoordinates(data.data.salondetail);
    ...
    loadCoordinates(salon) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const [longitude, latitude] = salon.location.coordinates;
            const location = yield this.geocoder.getLocationByCoords(latitude, longitude);
            return location;
        });
    }
};

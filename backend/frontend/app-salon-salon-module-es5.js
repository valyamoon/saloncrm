(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-salon-salon-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthService = /** @class */ (function () {
                ...
                AuthService.prototype.sendIdS = function (data) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CommonService = /** @class */ (function () {
                ...
                CommonService.prototype.saveSalonDetails = function (data) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DashboardComponent = /** @class */ (function () {
                ...
                DashboardComponent.prototype.toggleDropdown = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProfileComponent = /** @class */ (function () {
                function ProfileComponent(authServ, fb, commServ) {
                    var _this = this;
                ...
                ProfileComponent.prototype.ngOnInit = function () {
                    ...
                    this.authServ.currentIds.subscribe(function (data) {
                ...
                ProfileComponent.prototype.submitSalon = function (data) {
                    ...
                    this.commServ.saveSalonDetails(dataToPass).subscribe(function (data) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(toastServ, authServ, router, logServ, fb) {
                 ...
                 * @smartData Enterprises (I) Ltd
                 */
                LoginComponent.prototype.salonLogin = function (data) {
                    var _this = this;
                    this.logServ.loginSalon(data).subscribe(function (data) {
                        if (data.code === 200) {
                            _this.toastServ.success("Logged In Successfully", "", {
                                timeOut: 3000
                            });
                            _this.userData = data.data;
                            _this.authServ.sendIdS(data.data["userInfo"]["_id"]);
                            //(data.data['userInfo']['_id']);
                            _this.authServ.sendToken(data.data.token);
                            _this.router.navigate(["salon/home"]);
                        }
                        else {
                 ...
                 * @smartData Enterprises (I) Ltd
                 */
                LoginComponent.prototype.salonRegister = function (data) {
                    var _this = this;
                    var dataToPass = {
                        role: "salon",
                        email: data.email,
                    ...
                    this.logServ.signUpSalon(dataToPass).subscribe(function (res) {
                        if (res.code === 200) {
                            _this.toastServ.success("Registered Successfully", "Please Login", {
                                timeOut: 3000
                            });
                            _this.authServ.sendToken(res.data.token);
                        }
                        else if (res.code === 201) {
                            _this.toastServ.warning("User Already Exist", "Please Login", {
                                timeOut: 3000
                            });
                        }
                        else {
                            _this.toastServ.error("Failed to register", "Please try again", {
                                timeOut: 3000
                            });
                        }
                    });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginService = /** @class */ (function () {
                ...
                LoginService.prototype.loginSalon = function (data) {
                    return this.http.post(this.baseUrl + "/login", data, httpOptions);
                };
                LoginService.prototype.signUpSalon = function (data) {

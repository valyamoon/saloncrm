...
var AuthUserGuard = /** @class */ (function () {
    ...
    AuthUserGuard.ctorParameters = function () { return [
...
var DoctorSidebarComponent = /** @class */ (function () {
    function DoctorSidebarComponent(router, helperService, changeDetector) {
        var _this = this;
        this.router = router;
    ...
    DoctorSidebarComponent.prototype.ngAfterContentChecked = function () {
        this.changeDetector.detectChanges();
    };
    DoctorSidebarComponent.prototype.SettingMenu = function (element) {
    ...
    DoctorSidebarComponent.prototype.ngOnInit = function () {
    ...
    DoctorSidebarComponent.prototype.eventCalled = function () {
        this.isActive = !this.isActive;
    };
    DoctorSidebarComponent.prototype.addExpandClass = function (element) {
    ...
    DoctorSidebarComponent.prototype.toggleCollapsed = function () {
        this.collapsed = !this.collapsed;
        this.collapsedEvent.emit(this.collapsed);
    };
    DoctorSidebarComponent.prototype.isToggled = function () {
        var dom = document.querySelector('body');
        return dom.classList.contains(this.pushRightClass);
    };
    DoctorSidebarComponent.prototype.toggleSidebar = function () {
        var dom = document.querySelector('body');
        dom.classList.toggle(this.pushRightClass);
    };
    DoctorSidebarComponent.prototype.rltAndLtr = function () {
        var dom = document.querySelector('body');
    ...
    // }
    DoctorSidebarComponent.prototype.onLoggedout = function () {
        localStorage.removeItem('isLoggedin');
    };
    DoctorSidebarComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.logoutProvider = function () {
    };
...
var HospitalSidebarComponent = /** @class */ (function () {
    function HospitalSidebarComponent(router, changeDetector) {
        var _this = this;
        this.router = router;
        this.changeDetector = changeDetector;
        this.sidebarhide = false;
    ...
    HospitalSidebarComponent.prototype.ngAfterContentChecked = function () {
        this.changeDetector.detectChanges();
    };
    HospitalSidebarComponent.prototype.SettingMenu = function (element) {
        if (element === this.showSettingMenu) {
            this.showSettingMenu = '0';
        }
        else {
    ...
    HospitalSidebarComponent.prototype.ngOnInit = function () {
        this.isActive = false;
        this.collapsed = false;
        this.showMenu = '';
        this.pushRightClass = 'push-right';
    };
    HospitalSidebarComponent.prototype.eventCalled = function () {
        this.isActive = !this.isActive;
    };
    HospitalSidebarComponent.prototype.addExpandClass = function (element) {
        if (element === this.showMenu) {
            this.showMenu = '0';
        }
        else {
    ...
    HospitalSidebarComponent.prototype.toggleCollapsed = function () {
        this.collapsed = !this.collapsed;
        this.collapsedEvent.emit(this.collapsed);
    };
    HospitalSidebarComponent.prototype.isToggled = function () {
        var dom = document.querySelector('body');
        return dom.classList.contains(this.pushRightClass);
    };
    HospitalSidebarComponent.prototype.toggleSidebar = function () {
        var dom = document.querySelector('body');
        dom.classList.toggle(this.pushRightClass);
    };
    HospitalSidebarComponent.prototype.rltAndLtr = function () {
        var dom = document.querySelector('body');
        dom.classList.toggle('rtl');
    };
    // changeLang(language: string) {
    //     this.translate.use(language);
    // }
    HospitalSidebarComponent.prototype.onLoggedout = function () {
        localStorage.removeItem('isLoggedin');
    };
    HospitalSidebarComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    return HospitalSidebarComponent;
}());
...
var NgoSidebarComponent = /** @class */ (function () {
    function NgoSidebarComponent(router, changeDetector) {
        var _this = this;
        this.router = router;
        this.changeDetector = changeDetector;
        this.sidebarhide = false;
    ...
    NgoSidebarComponent.prototype.ngAfterContentChecked = function () {
        this.changeDetector.detectChanges();
    };
    NgoSidebarComponent.prototype.SettingMenu = function (element) {
        if (element === this.showSettingMenu) {
            this.showSettingMenu = '0';
        }
        else {
    ...
    NgoSidebarComponent.prototype.ngOnInit = function () {
        this.isActive = false;
        this.collapsed = false;
        this.showMenu = '';
        this.pushRightClass = 'push-right';
    };
    NgoSidebarComponent.prototype.eventCalled = function () {
        this.isActive = !this.isActive;
    };
    NgoSidebarComponent.prototype.addExpandClass = function (element) {
        if (element === this.showMenu) {
            this.showMenu = '0';
        }
        else {
    ...
    NgoSidebarComponent.prototype.toggleCollapsed = function () {
        this.collapsed = !this.collapsed;
        this.collapsedEvent.emit(this.collapsed);
    };
    NgoSidebarComponent.prototype.isToggled = function () {
        var dom = document.querySelector('body');
        return dom.classList.contains(this.pushRightClass);
    };
    NgoSidebarComponent.prototype.toggleSidebar = function () {
        var dom = document.querySelector('body');
        dom.classList.toggle(this.pushRightClass);
    };
    NgoSidebarComponent.prototype.rltAndLtr = function () {
        var dom = document.querySelector('body');
        dom.classList.toggle('rtl');
    };
    // changeLang(language: string) {
    //     this.translate.use(language);
    // }
    NgoSidebarComponent.prototype.onLoggedout = function () {
        localStorage.removeItem('isLoggedin');
    };
    NgoSidebarComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var PatientSidebarComponent = /** @class */ (function () {
    function PatientSidebarComponent(router, helperService, changeDetector) {
        var _this = this;
        this.router = router;
        this.helperService = helperService;
        this.changeDetector = changeDetector;
    ...
    PatientSidebarComponent.prototype.ngAfterContentChecked = function () {
        this.changeDetector.detectChanges();
    };
    PatientSidebarComponent.prototype.SettingMenu = function (element) {
        if (element === this.showSettingMenu) {
            this.showSettingMenu = '0';
        }
        else {
    ...
    PatientSidebarComponent.prototype.ngOnInit = function () {
        // this.helperService.getUserPermission().subscribe(permission => {
        //     const obj_menu: any = {};
        //     const list_controller: any = permission['data'].controller || [];
        //     const controller_actions: any = permission['data'].action_map || [];
    ...
    PatientSidebarComponent.prototype.eventCalled = function () {
        this.isActive = !this.isActive;
    };
    PatientSidebarComponent.prototype.addExpandClass = function (element) {
        if (element === this.showMenu) {
            this.showMenu = '0';
        }
        else {
    ...
    PatientSidebarComponent.prototype.toggleCollapsed = function () {
        this.collapsed = !this.collapsed;
        this.collapsedEvent.emit(this.collapsed);
    };
    PatientSidebarComponent.prototype.isToggled = function () {
        var dom = document.querySelector('body');
        return dom.classList.contains(this.pushRightClass);
    };
    PatientSidebarComponent.prototype.toggleSidebar = function () {
        var dom = document.querySelector('body');
        dom.classList.toggle(this.pushRightClass);
    };
    PatientSidebarComponent.prototype.rltAndLtr = function () {
        var dom = document.querySelector('body');
        dom.classList.toggle('rtl');
    };
    PatientSidebarComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: src_app_services_helper_service__WEBPACK_IMPORTED_MODULE_3__["HelperService"] },
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] }
    ]; };
...
var PharmacySidebarComponent = /** @class */ (function () {
    function PharmacySidebarComponent(router, helperService, changeDetector) {
        var _this = this;
        this.router = router;
        this.helperService = helperService;
        this.changeDetector = changeDetector;
    ...
    PharmacySidebarComponent.prototype.ngAfterContentChecked = function () {
        this.changeDetector.detectChanges();
    };
    PharmacySidebarComponent.prototype.SettingMenu = function (element) {
        if (element === this.showSettingMenu) {
            this.showSettingMenu = '0';
        }
        else {
    ...
    PharmacySidebarComponent.prototype.orderMenu = function (element) {
    ...
    PharmacySidebarComponent.prototype.ngOnInit = function () {
        // this.helperService.getUserPermission().subscribe(permission => {
        //     const obj_menu: any = {};
        //     const list_controller: any = permission['data'].controller || [];
        //     const controller_actions: any = permission['data'].action_map || [];
    ...
    PharmacySidebarComponent.prototype.eventCalled = function () {
        this.isActive = !this.isActive;
    };
    PharmacySidebarComponent.prototype.addExpandClass = function (element) {
        if (element === this.showMenu) {
            this.showMenu = '0';
        }
        else {
    ...
    PharmacySidebarComponent.prototype.toggleCollapsed = function () {
        this.collapsed = !this.collapsed;
        this.collapsedEvent.emit(this.collapsed);
    };
    PharmacySidebarComponent.prototype.isToggled = function () {
        var dom = document.querySelector('body');
        return dom.classList.contains(this.pushRightClass);
    };
    PharmacySidebarComponent.prototype.toggleSidebar = function () {
        var dom = document.querySelector('body');
        dom.classList.toggle(this.pushRightClass);
    };
    PharmacySidebarComponent.prototype.rltAndLtr = function () {
        var dom = document.querySelector('body');
        dom.classList.toggle('rtl');
    };
    // changeLang(language: string) {
    //     this.translate.use(language);
    // }
    PharmacySidebarComponent.prototype.onLoggedout = function () {
        localStorage.removeItem('isLoggedin');
    };
    PharmacySidebarComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
    ...
    return PharmacySidebarComponent;
}());
...
var SidebarComponent = /** @class */ (function () {
    function SidebarComponent(helperService, resolver) {
        this.helperService = helperService;
    ...
    SidebarComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.helperService.getUserPermission().subscribe(function (response) {
            _this.isLoading = true;
            _this.roleType = response['data'].role_type ? response['data'].role_type : '';
            _this.createComponent(_this.config.decriptData(_this.roleType));
        });
    };
    SidebarComponent.prototype.createComponent = function (role_type) {
        if (role_type === 'doctor') {
            this.entry.clear();
            var factory = this.resolver.resolveComponentFactory(_doctor_sidebar_doctor_sidebar_component__WEBPACK_IMPORTED_MODULE_3__["DoctorSidebarComponent"]);
            this.componentRef = this.entry.createComponent(factory);
            this.isLoading = false;
        }
        else if (role_type === 'pharmacy') {
            this.entry.clear();
            var factory = this.resolver.resolveComponentFactory(_pharmacy_sidebar_pharmacy_sidebar_component__WEBPACK_IMPORTED_MODULE_4__["PharmacySidebarComponent"]);
            this.componentRef = this.entry.createComponent(factory);
            this.isLoading = false;
        }
        else if (role_type === 'patient') {
            this.entry.clear();
            var factory = this.resolver.resolveComponentFactory(_patient_sidebar_patient_sidebar_component__WEBPACK_IMPORTED_MODULE_5__["PatientSidebarComponent"]);
            this.componentRef = this.entry.createComponent(factory);
            this.isLoading = false;
        }
        else if (role_type === 'NGO') {
            this.entry.clear();
            var factory = this.resolver.resolveComponentFactory(_ngo_sidebar_ngo_sidebar_component__WEBPACK_IMPORTED_MODULE_8__["NgoSidebarComponent"]);
            this.componentRef = this.entry.createComponent(factory);
            this.isLoading = false;
        }
        else if (role_type === 'Hospital') {
            this.entry.clear();
            var factory = this.resolver.resolveComponentFactory(_hospital_sidebar_hospital_sidebar_component__WEBPACK_IMPORTED_MODULE_7__["HospitalSidebarComponent"]);
            this.componentRef = this.entry.createComponent(factory);
            this.isLoading = false;
        }
    };
...
var routes = [
    {
        ...
        children: [
            ...
            { path: 'dashboard', loadChildren: function () { return __webpack_require__.e(/*! import() | dashboard-dashboard-module */ "dashboard-dashboard-module").then(__webpack_require__.bind(null, /*! ./dashboard/dashboard.module */ "./src/app/layout/dashboard/dashboard.module.ts")).then(function (m) { return m.DashboardModule; }); } }
        ]
    }
];

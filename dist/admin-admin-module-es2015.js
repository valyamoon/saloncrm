...
const routes = [
    {
        ...
        children: [
            ...
            { path: 'dashboard', loadChildren: () => Promise.all(/*! import() | admin-dashboard-dashboard-module */[__webpack_require__.e("common"), __webpack_require__.e("admin-dashboard-dashboard-module")]).then(__webpack_require__.bind(null, /*! ./admin/dashboard/dashboard.module */ "./src/app/admin/admin/dashboard/dashboard.module.ts")).then(m => m.DashboardModule) },
            { path: 'stores', loadChildren: () => Promise.all(/*! import() | admin-stores-stores-module */[__webpack_require__.e("default~admin-stores-stores-module~auth-admin-login-admin-login-module"), __webpack_require__.e("common"), __webpack_require__.e("admin-stores-stores-module")]).then(__webpack_require__.bind(null, /*! ./admin/stores/stores.module */ "./src/app/admin/admin/stores/stores.module.ts")).then(m => m.StoresModule) },
            { path: 'drivers', loadChildren: () => __webpack_require__.e(/*! import() | admin-drivers-drivers-module */ "admin-drivers-drivers-module").then(__webpack_require__.bind(null, /*! ./admin/drivers/drivers.module */ "./src/app/admin/admin/drivers/drivers.module.ts")).then(m => m.DriversModule) },
        ]
    }
];

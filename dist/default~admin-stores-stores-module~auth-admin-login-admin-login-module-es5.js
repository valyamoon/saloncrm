...
var ConfirmDialogComponent = /** @class */ (function () {
    function ConfirmDialogComponent(dialogRef, config) {
...
/* harmony import */ var ngx_material_timepicker__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ngx-material-timepicker */ "./node_modules/ngx-material-timepicker/fesm5/ngx-material-timepicker.js");
...
var MomentFormatPipe = /** @class */ (function () {
    ...
    MomentFormatPipe.prototype.transform = function (value, timezone, format) {
...
var RemoveHtmlTag = /** @class */ (function () {
    function RemoveHtmlTag() {
    }
    RemoveHtmlTag.prototype.transform = function (value) {
...
var StatusDialogComponent = /** @class */ (function () {
    function StatusDialogComponent(dialogRef, config) {
        this.dialogRef = dialogRef;
        this.config = config;
    }
    ...
    StatusDialogComponent.ctorParameters = function () { return [
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] }
    ]; };
...
var UPLOAD_VALUE_ACCESSOR = {
    ...
    useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(function () { return TnFileUploadComponent; }),
    multi: true,
};
var TnFileUploadComponent = /** @class */ (function () {
    function TnFileUploadComponent(sanitizer) {
    ...
    TnFileUploadComponent.prototype.ngOnInit = function () {
    };
    TnFileUploadComponent.prototype.ngOnChanges = function (changes) {
    ...
    TnFileUploadComponent.prototype.writeValue = function (value) {
        var _this = this;
        ...
        if (typeof this.value == 'string' && this.value) {
            ...
            this.images = [];
            this.files = [];
            Array.from(this.value).map(function (img) {
                _this.images.push({ url: img });
            });
        }
    };
    TnFileUploadComponent.prototype.pushChanges = function (value) {
        console.log('pushChanges', value);
        this.onChange(value);
    };
    TnFileUploadComponent.prototype.registerOnChange = function (fn) {
        this.onChange = fn;
    };
    TnFileUploadComponent.prototype.registerOnTouched = function (fn) { this.onTouched = fn; };
    TnFileUploadComponent.prototype.setDisabledState = function (isDisabled) {
    };
    TnFileUploadComponent.prototype.tnImportFile = function (e) {
        var _this = this;
        this.msg = '';
        var eFiles = e.target || e.srcElement;
        var new_files = [];
        if (eFiles.files && eFiles.files.length <= this.maxFileCount) {
            this.showSpinner = true;
            this.files = Array.from(eFiles.files);
            this.images = [];
            new_files = this.files.map(function (item, i) {
            ...
            Promise.all(new_files)
                ...
                res.map(function (val) {
                    _this.images.push(val.obj);
                    _this.files.push(val.fileToRead);
                });
                _this.value = '';
                if (_this.multiple) {
    ...
    TnFileUploadComponent.prototype.readFile = function (fileToRead) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var fileReader = new FileReader();
            fileReader.onload = function (event) {
                console.log('readFile', fileToRead);
                if ((_this.restrictSize && (fileToRead.size / Math.pow(1024, 2)) >= _this.restrictSize) || !_this.restrictSize) {
                    var ext = fileToRead.type.indexOf('/') != -1 ? fileToRead.type.split('/')[1] : '';
                    var preext = fileToRead.type.indexOf('/') != -1 ? fileToRead.type.split('/')[0] : '';
                    var obj = {
                    ...
                    return resolve({ fileToRead: fileToRead, obj: obj });
                }
                else {
                    return reject('File size should be more than ' + _this.restrictSize + ' MB');
                }
            };
            fileReader.readAsDataURL(fileToRead);
        });
    };
    TnFileUploadComponent.prototype.tnRemoveAll = function () {
        this.files = [];
    ...
    TnFileUploadComponent.prototype.tnRemove = function (index) {
    ...
    TnFileUploadComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=default~admin-stores-stores-module~auth-admin-login-admin-login-module-es5.js.map
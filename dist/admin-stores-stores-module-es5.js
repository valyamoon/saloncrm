...
var AddComponent = /** @class */ (function () {
    function AddComponent(storeService, fb, notificationService, activatedRoute, router) {
    ...
    AddComponent.prototype.getStoreById = function (id) {
        var _this = this;
        if (id) {
            var obj = { id: id };
            this.storeService.getOneStore(obj).subscribe(function (res) {
                _this.storsForm.get('name').setValue(res['data'].name);
                console.log(res['data']);
                if (res['data'].length > 0) {
                    var data = res['data'][0];
                    _this.storsForm.patchValue({
                        name: data.name || '',
    ...
    AddComponent.prototype.addStore = function () {
        var _this = this;
        if (this.storsForm.valid) {
            var data = this.storsForm.value;
            var serv = void 0;
            if (this._id) {
            ...
            serv.subscribe(function (res) {
                _this.router.navigate(['/howd-admin/stores']);
...
var StoresComponent = /** @class */ (function () {
    function StoresComponent(storeService, notificationService) {
        this.storeService = storeService;
        this.notificationService = notificationService;
        this.totalCount = 0;
        this.limit = 5;
    ...
    StoresComponent.prototype.getStoreList = function () {
        var _this = this;
        var request_obj = {
            page: 0,
            limit: 10,
        ...
        this.storeService.listStore(request_obj).subscribe(function (res) {
            ...
            _this.templateData = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](res['data']);
            _this.totalCount = res.total;
        }, function () {
            _this.notificationService.infoToast(src_app_core_utils_string_constants__WEBPACK_IMPORTED_MODULE_5__["StringConst"].SOMETHING_WENT_WRONG + ' ' + src_app_core_utils_string_constants__WEBPACK_IMPORTED_MODULE_5__["StringConst"].PLEASE_TRY_AGAIN_LATER);
        });
    };
    StoresComponent.prototype.pageChange = function (event) {
...
//# sourceMappingURL=admin-stores-stores-module-es5.js.map